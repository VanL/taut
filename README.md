...
```bash
pipx install "git+https://github.com/VanL/taut.git@v0.6.2"       # CLI use
uv add "taut @ git+https://github.com/VanL/taut.git@v0.6.2"      # as a library
```
...
```bash
pipx install "git+https://github.com/VanL/taut.git@v0.6.2"
pipx inject taut ./taut_pg-0.6.2-py3-none-any.whl
```
...
```bash
pipx inject taut ./taut_summon-0.6.2-py3-none-any.whl
```
