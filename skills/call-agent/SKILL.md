...
boundary line: "You are reviewing; do not implement
or modify anything. Stay within this repository's files."
...
filling the brackets IS the scope decision; if a bracket resists
filling, the scope is undecided and the dispatch is premature. Two named
