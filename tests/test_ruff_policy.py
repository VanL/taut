...
SELECTED_RULES = ["E", "W", "F", "I", "B", "C4", "UP", "C901"]
...
def test_active_configs_select_only_the_reviewed_rules_at_complexity_ten() -> None:
    ...
    for project in (root, mcp):
        ...
        assert lint["select"] == SELECTED_RULES
...
def test_raw_active_rule_inventory_and_registry_are_exact() -> None:
    ...
    assert len(snapshot.directives) == 38
