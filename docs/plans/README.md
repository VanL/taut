...
| `2026-08-24-extension-seams-process-containment-coverage-plan.md` | active | no | Class 5+P hardened plan; E1 public activity-neutral core/MCP seams and the historical compatibility canary landed at `d5e3be2`, while E2 process containment and T1 coverage production remain unpromoted. |
