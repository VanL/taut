...
| `2026-08-10-test-quality-remediation-plan.md` | completed | no | Class 4 repository-wide test-oracle remediation; 80 audited dispositions with hosted OS/Python, required-path, and coverage-preservation evidence recorded in the plan. |
