...
| `2026-08-10-test-quality-remediation-plan.md` | active | no | Class 4 repository-wide test-oracle remediation with replacement-before-deletion ownership and explicit coverage-preservation gates. |
