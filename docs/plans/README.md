...
|------|--------|----------|------|
| `2026-09-01-release-ci-test-determinism-plan.md` | active | no | Class 4 exact-SHA release-blocker correction across root, Summon, and TUI test harnesses plus existing TUI diagnostic-precedence restoration; preserves assertions, timeout budgets, parallelism, and all release gates. |
