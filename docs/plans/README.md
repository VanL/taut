...
| `2026-08-18-mcp-resource-helper-seed-lifecycle-plan.md` | active | no | Class 4 correction bounding the selected identity's persistent seed ownership after the 0.9.3 Windows MCP pre-tag gate sampled SQLite commit during resource fixture setup. |
