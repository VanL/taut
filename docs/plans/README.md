...
| `2026-08-18-mcp-windows-resource-timeout-budget-plan.md` | active | no | Class 4 correction scaling only MCP resource-test outer deadlock caps by 3x on Windows while retaining all behavior deadlines and assertions. |
