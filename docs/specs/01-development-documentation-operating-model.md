...
| `[RUFF-SUP-092]` | `BLE001`, `C901` | `19` directives; raw: `BLE001=15`, `C901=4` | The disposable native ConPTY qualification coordinator owns one bounded setup, fault-injection, cleanup, and evidence transaction; worker and cleanup failures must remain in its single JSON record | Hosted Windows process probe plus independent lifecycle review | Splitting ownership into unshipped abstractions or losing control-flow failures before the qualification record | Temporary Slice 1 evidence only; independently reviewed under the 2026-09-03 unified PTY plan and deleted before production promotion. |

Global raw-`noqa` inventory: `BLE001=160`, `C901=42`, `DTZ006=1`, `F401=1`, `FLY002=16`, `FURB122=1`, `LOG001=1`, `N999=6`, `PYI041=1`, `RUF015=2`, `S110=3`, `SIM115=3`, `SIM117=7`, `TRY004=15`
...
| `[RUFF-SUP-092]` | `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::AttachSink._run`; `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::EpochWriter.cancel_blocked`; `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::EpochWriter.privileged_close_interrupt`; `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::EpochWriter.start`; `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::OutputDrain._run`; `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::run_client`; `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::run_console_probe`; `extensions/taut_summon/tests/fixtures/temporary_conpty_qualification.py::run_coordinator` | 19 | `BLE001=15`, `C901=4` |
