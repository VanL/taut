...
| `[RUFF-SUP-091]` | `C901` | `1` directive; raw: `C901=1` | Summon watcher supervision keeps readiness, cancellation, shutdown, provider death, checked join, and failure-budget precedence in one lifecycle owner | watcher cancellation, readiness deadline, shutdown, and failure-rebuild tests | Splitting lifecycle decisions across callback threads or duplicating retry ownership | Reported-issues follow-up plan and implementation independently reviewed; user-authorized implementation 2026-09-15. |
...
Global raw-`noqa` inventory: `BLE001=136`, `C901=37`, `DTZ006=1`, `F401=1`, `FLY002=16`, `FURB122=1`, `LOG001=1`, `N999=6`, `PYI041=1`, `RUF015=2`, `S110=3`, `SIM115=3`, `SIM117=7`, `TRY004=11`
...
| `[RUFF-SUP-091]` | `extensions/taut_summon/taut_summon/_driver.py::SummonDriver._watch_until_wake` | 1 | `C901=1` |
