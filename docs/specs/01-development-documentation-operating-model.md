...
| `[RUFF-SUP-085]` | `BLE001` | `16` directives; raw: `BLE001=16` | TUI domain, extension, and syntax-provider boundaries render arbitrary backend, plugin, and provider failures inline without losing the active UI | TUI domain-action, extension-startup, command-syntax-provider, search, and Summon error-path tests | Guessing third-party/provider exception classes or allowing a domain or provider failure to terminate the Textual event loop | TUI command-mirror and Summon attach-handoff implementations independently reviewed; owner-authorized implementation 2026-08-17. |
...
Global raw-`noqa` inventory: `BLE001=137`, `C901=38`, `DTZ006=1`, `F401=1`, `FLY002=16`, `FURB122=1`, `LOG001=1`, `N999=6`, `PYI041=1`, `RUF015=2`, `S110=3`, `SIM115=3`, `SIM117=7`, `TRY004=15`
