...
| `[RUFF-SUP-068]` | `BLE001` | `4` directives; raw: `BLE001=4` | Optional notification, reaction, and login-name integrations remain best-effort across backend and platform failures | Messaging, notification, and identity fallback tests | Making optional side effects fail the owning operation or enumerating backend and platform exception classes | Independent review passed; user-approved exact fields 2026-08-05; post-commit sender-cursor catch-up added under the independently reviewed 2026-09-14 audit remediation plan. |
...
| `[RUFF-SUP-068]` | `taut/client/_messaging.py::MessagingMixin._advance_sender_if_no_intervening`; `taut/client/_messaging.py::MessagingMixin.react_to_message`; `taut/client/_notifications.py::NotificationsMixin._write_notification`; `taut/identity.py::_login_name` | 4 | `BLE001=4` |
