...
| Plans | 2026-08-14, base `0a9d9bb` (local-only pin) plus concurrent active-plan row | 71 indexed plans in the current tree: 63 completed, 4 superseded, 4 active, 0 retired-pending; 66 completed/superseded non-exemplars remain eligible against threshold 8 | Checked-deferred after physical deletion closed the second four-plan retirement batch: the remaining backlog is volume-limited, with no blocker class found in the last audited oldest-first batch | The next authorized sweep or completion boundary gates the next four-plan soft-retirement batch |
