...
| Plans | (progress is the Retired Plans ledger, not a cursor — three four-plan soft-retirement batches recorded through 2026-08-24) | per-plan, see ledger |
...
| Plans | 2026-09-23, sources `348eae9`, `24dc2bc`, `3cae1f4` | 116 indexed plans after deletion: 98 completed non-exemplars, 3 exemplars, 5 superseded, 9 active, 1 status-review, 0 retired-pending; 103 completed/superseded non-exemplars remain eligible against threshold 8 | The 2026-08-24 soft-retired batch was re-verified and deleted. No new harvest blocker class was found. The eligible remainder stays volume-limited to the next four-plan batch | The next four oldest eligible non-exemplar plans pass the harvest gate and are soft-retired, or a later sweep records a blocker for that batch |
