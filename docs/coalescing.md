...
|------|------------------------------|-----------------|-----------------|-----------------|
| Lessons | 2026-08-24, source `f17612b` | 81 dated entries: 33 past the 2026-07-14 watermark, all inside the 30-day age floor; 0 cold eligible against threshold 20 | Checked-deferred: the oldest post-watermark entry is 2026-07-27 and remains inside the age floor; all 33 stay verbatim and the watermark is unchanged | Recount when the 2026-07-27 entry reaches the 30-day age floor on 2026-08-26, or sooner if 20 new cold eligible entries accumulate |
...
| Promotion | 2026-08-24, source `f17612b` | 3 candidate themes: xdist worker-kill containment; summon harness readiness/token discipline; and causal synchronization/resource ownership in tests (4 independent July entries) | Re-derived against all 33 post-watermark entries: newer release, TUI, and Summon clusters remain hot or product-owned, and no new stable unowned workflow theme crossed the threshold; existing durable-guidance amendments remain separate owner-gated Class 3+P units | A Class 3+P runbook/implementation-note amendment unit is authorized, a new unowned workflow theme reaches 3 independent citations, or the hot product-owned clusters close and later independent citations establish recurrence |
